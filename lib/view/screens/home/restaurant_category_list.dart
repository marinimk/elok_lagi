...
class RestaurantCategoryList extends StatelessWidget {
  final String category;
  RestaurantCategoryList({this.category});
              ...
              children: [
                  ...
                  children: <Widget>[
                    Expanded(
                        child: Container(
                            height: 4,
                            decoration:
                                BoxDecoration(color: colorsConstBrown[300]))),
                    Padding(
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) => restaurant[index]
                                .category ==
                            category
                        ? Container(
                            height: 245,
