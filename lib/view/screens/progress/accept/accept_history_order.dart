...
import 'package:elok_lagi/view/screens/progress/accept/accept_history_food.dart';
import 'package:elok_lagi/view/screens/progress/accept/submit_feedback.dart';
import 'package:elok_lagi/view/screens/progress/accept/view_feedback.dart';
...
class _AcceptHistoryOrderState extends State<AcceptHistoryOrder> {
    ...
    return StreamBuilder<AcceptHistory>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            return Scaffold(
              appBar: ElAppBarOrder(title: history.ahid, leading: true),
              body: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                        height: 290,
                        child: AcceptHistoryFood(hid: history.ahid)),
                    divider(),
                    Container(
                      height: 175,
                            ...
                            ? Row(
                                ...
                                children: [
                                  ElevatedButton(
                                    ...
                                    onPressed: () async =>
                                        submitFeedback(context, history),
                                    child: buttonTextRow(
                                        Icons.check_circle, 'SUBMIT FEEDBACK'),
                                  ),
                                ],
                              )
                            : Row(
  ...
  Future submitFeedback(BuildContext context, AcceptHistory history) {
